...
export class LoggerService {
  constructor() {
    ...
    const combinedLogPath: string = config.paths?.log
      ? `${config.paths?.log}/%DATE%/%DATE%_combined_${id}.log`
      : `logs/%DATE%/%DATE%_combined.log`;
    ...
    const errorLogPath: string =
      'production' === config.paths?.log
        ? `${config.paths?.log}/%DATE%/errors/%DATE%_error_${id}.log`
        : `logs/%DATE%/errors/%DATE%_error.log`;
